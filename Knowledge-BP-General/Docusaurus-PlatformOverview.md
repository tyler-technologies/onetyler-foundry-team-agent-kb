...
| **Identity** | "**Identity**", "**Identity Workforce**", "**Identity Community**", "**Gateway**" / Workforce Direct / Managed / Delegated / Global, federation setup, credential templates, login/token flows, the TID services | https://docs.tylerdev.io/identity |
...
**Identity Workforce** — organization-managed cloud identity for back-office users enabling SSO across participating Tyler products. Options: **Workforce Direct** (customer has a public-facing IdP to federate to and owns authentication responsibility — Tyler's default-favored option), **Workforce Managed** (Tyler-managed back-office user store, currently Okta, for regulatory/business needs) and **Workforce Global** (lets an org own domains shared across several other orgs, while also supporting non-federated users like Workforce Managed; expected to become the default starting Q4 2026). ⚠ **Workforce Global is in Private Preview as of 8/28/26** (GA anticipated Q4 2026) — always state the stage; setup steps: https://tylertech.atlassian.net/wiki/spaces/TTI/pages/1812041041/Tyler+Cloud+Platform+TCP+Workforce+Global+Setup+Workflow. → deep content: **Identity specialized agent**.
