...
notes: Classified by Claude from the Proposed fix (no exchange-level correction). Client-side Entra ID app-registration steps added to FAQ-Identity.md; registered in _START_HERE.md.
